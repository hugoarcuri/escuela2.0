            ...
            {list.map(e => {
              ...
              <div key={e.id} className="flex items-center justify-between p-2 rounded-lg"
                ...
                <div className="flex gap-1 shrink-0">
                  <button onClick={() => editItem(e)} className="text-xs px-2 py-1 rounded hover:bg-[var(--hover-bg)] min-h-[44px]" style={{ color: "var(--accent)" }}>Editar</button>
                  <button onClick={() => handleDelete(e.id)} className="text-xs px-2 py-1 rounded hover:bg-[var(--hover-bg)] min-h-[44px]" style={{ color: "var(--danger)" }}>Eliminar</button>
                </div>
              </div>
              );
            })}
